                    ...
                    <div class="col-md-8 pt-1 ">
                        <div class="card" style="border: 0;">
                            <div class="card-body pt-3 pb-2">
                                <form action="insert-course" method="post" enctype="multipart/form-data" id="course-form">
                                    @csrf <!-- ใส่ CSRF token -->
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="location[]"
                                            value="บริเวณ ม.ทักษิณ วิทยาเขตพัทลุง" id="flexCheckDefault1">
                                        <label class="form-check-label" for="flexCheckDefault1">
                                            บริเวณ ม.ทักษิณ วิทยาเขตพัทลุง
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="location[]" value="ออนไลน์"
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="course_type"
                                            id="flexRadioDefault2" value="สอนตัวต่อตัว" checked>
                                    ...
                                    <div class="form-group pt-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="เช่น วันเสาร์-อาทิตย์"
                                            name="teaching_days">
                                        @error('teaching_days')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="form-group pt-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="เช่น 18.00-20.00 น."
                                            name="teaching_times">
                                    ...
                                    <div class="d-flex justify-content-center mt-3">
                                        ...
                                        <div class="btn-group" role="group" aria-label="Second group">
                                            ...
                                            <button type="button" class="btn btn-primary btn-sm"
                                                id="confirm-button">ยืนยันการเพิ่ม</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <script>
        ...
        document.getElementById('confirm-button').addEventListener('click', function() {
            ...
            Swal.fire({
                ...
                text: 'คุณแน่ใจที่จะเพิ่มข้อมูลนี้หรือไม่?',
                icon: 'question',
